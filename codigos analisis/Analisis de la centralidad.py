...
fig, axs = plt.subplots(figsize = (12, 8), facecolor = "None")
...
fig, axs = plt.subplots(figsize = (8, 5), facecolor = "None")
...
#plt.savefig(f"../imagenes del analisis/centralidad por genero.png")
plt.show()
